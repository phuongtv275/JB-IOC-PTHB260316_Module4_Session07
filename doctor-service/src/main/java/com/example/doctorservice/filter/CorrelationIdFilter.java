package com.example.doctorservice.filter;
...
/**
 * Filter bắt và thiết lập Correlation ID cho từng request HTTP trong doctor-service.
 * 
 * Đảm bảo:
 * 1. Bắt hoặc sinh mới Correlation ID cho mọi request.
 * 2. Đưa vào SLF4J MDC để tự động xuất hiện trên mọi dòng log.
 * 3. Đính kèm vào response header 'X-Correlation-Id'.
 * 4. Đo lường thời gian thực thi request.
 * 5. Xóa dữ liệu MDC trong khối finally để tránh rò rỉ bộ nhớ giữa các thread.
 */
@Slf4j
@Component
